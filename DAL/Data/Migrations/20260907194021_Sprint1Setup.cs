...
{
    /// <inheritdoc />
    public partial class Sprint1Setup : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxMemoryLimitMb = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Exercises_CourseModules_ModuleId",
                        column: x => x.ModuleId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CodeDrafts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CodeDrafts_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CodeDrafts_Exercises_ExerciseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CodeDrafts_ExerciseId",
                table: "CodeDrafts",
                column: "ExerciseId");

            migrationBuilder.CreateIndex(
                name: "IX_CodeDrafts_UserId_ExerciseId",
                table: "CodeDrafts",
